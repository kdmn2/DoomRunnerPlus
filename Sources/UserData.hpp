...
//======================================================================================================================
// options - data that constitute the launch command
...
struct IWAD : public AModelItem
{
	...
	QJsonObject serialize() const;
	bool deserialize( const JsonObjectCtx & iwadJs );
};

struct Mod : public AModelItem
{
	QString path;           ///< path to the mod file
	QString name;           ///< cached file name derived from the path, beware of inconsistencies
...
//======================================================================================================================
// settings & state - values that determine the launcher's state, appearance and behaviour
...
struct EngineSettings
{
	...
	QJsonObject serialize() const;
	void deserialize( const JsonObjectCtx & settingsJs );
};
...
struct LauncherSettings : public StorageSettings  // inherited instead of included to avoid long identifiers
{
	...
	void serialize( QJsonObject & settingsJs ) const;
	void deserialize( const JsonObjectCtx & settingsJs );
};
...
struct SearchState
{
	...
	QJsonObject serialize() const;
	void deserialize( const JsonObjectCtx & searchJs );
};
...
struct UIState
{
	...
	void serialize( QJsonObject & stateJs ) const;
	void deserialize( const JsonObjectCtx & stateJs );
};
...
struct WindowGeometry
{
	...
	QJsonObject serialize() const;
	void deserialize( const JsonObjectCtx & geometryJs );
};
